...
dependencies {
  ...
  implementation("com.fasterxml.jackson.datatype:jackson-datatype-jsr310:2.22.2") // also needed runtime for AppInsights
  ...
  runtimeOnly("com.fasterxml.jackson.datatype:jackson-datatype-jsr310:2.22.2") // needed for OffsetDateTime for AppInsights
  ...
  implementation("org.hibernate:hibernate-core:7.4.7.Final")
